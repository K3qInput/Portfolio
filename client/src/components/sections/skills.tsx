      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 flex-1 content-start overflow-y-auto max-h-[380px]">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 flex-1 content-start overflow-y-auto max-h-[380px]">
