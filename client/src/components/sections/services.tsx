  ...
  return (
    <section id="services" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        >
          <Button asChild size="lg" className="bg-gradient-to-r from-green-primary to-green-400 hover:from-green-600 hover:to-green-500 text-black font-bold text-lg px-8 py-4 shadow-xl shadow-green-primary/20 border-2 border-green-primary/30 hover:shadow-green-primary/40 transition-all duration-300">
            <Link href="/services">
